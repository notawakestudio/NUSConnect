import { Checkbox, FormControl, FormErrorMessage, FormLabel, useToast } from '@chakra-ui/react'
      ...
      <Layout>
        ...
        <Formik
          ...
          validationSchema={Yup.object({
            ...
            type: Yup.string().required('Type of question is needed'),
            question: Yup.string().trim().required('Question is empty'),
            answers: Yup.array().min(2, 'Must have at least 2 options'),
          })}
              ...
              <Form className="container max-w-3xl mx-auto shadow-md md:w-3/4">
                ...
                <div className="space-y-6 bg-white">
                  ...
                  <div className="items-center w-full p-8 space-y-4 text-gray-500 md:inline-flex md:space-y-0">
                    ...
                    <div className="w-full pl-2 mx-auto max-w-md md:w-10/12">
