...
const SideBar = (): JSX.Element => {
  return (
    <div className="min-h-screen hidden relative w-56 lg:flex flex-col flex-auto flex-shrink-0 ">
      <div className="fixed flex flex-col top-18 left-0 w-56 dark:bg-gray-900 h-full shadow-lg">
        <div className="flex items-center pl-6 h-20 border-b dark:border-gray-800">
          <div className="ml-1">
            <p className="ml-1 text-md font-medium tracking-wide truncate dark:text-gray-100 font-sans">Student</p>
            <div className="badge">
        ...
        <div className="overflow-y-auto overflow-x-hidden flex-grow">
          <ul className="flex flex-col py-6 space-y-1">
            ...
            <li>
              <Link href="/quiz">
                <div className="hover:cursor-pointer relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-500 hover:text-gray-200 border-l-4 border-transparent hover:border-blue-500 pr-6">
                  <span className="inline-flex justify-center items-center ml-4">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path
                        strokeLinecap="round"
                  ...
                  <span className="ml-2 font-semibold text-sm tracking-wide truncate font-sans">Quiz</span>
                </div>
              </Link>
            </li>
            <li>
              <Link href="/forum">
                <div className="hover:cursor-pointer relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-500 hover:text-gray-200 border-l-4 border-transparent hover:border-blue-500 pr-6">
                  ...
                  <span className="ml-2 font-semibold text-sm tracking-wide truncate font-sans">Forum</span>
                </div>
              </Link>
            </li>
            <li>
              ...
              >
                ...
                <span className="ml-2 font-semibold text-sm tracking-wide truncate font-sans">Inbox</span>
